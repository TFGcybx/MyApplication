...
import com.example.myapplication.CircleSpiriter;
...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    {
        private final ArrayList<CircleSpiriter> spriters=new ArrayList<>();
        private boolean isStopped=false;
        public DrawThread()
        {
            spriters.add(new CircleSpiriter(100,100,100,GameView.this.getWidth(),GameView.this.getHeight()));
            spriters.add(new CircleSpiriter(300,300,100,GameView.this.getWidth(),GameView.this.getHeight()));
        }
        ...
        public void run() {
            ...
            while(!isStopped) {
                try {
                    ...
                    canvas.drawText("score: "+hitCount,100,100,paint);
