...
public class Fragment_BOOKLIST extends Fragment {
    ...
    androidx.activity.result.ActivityResultLauncher<Intent> launcherAdd=registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        @Override
    ...
    androidx.activity.result.ActivityResultLauncher<Intent> launcherEdit = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        @Override
        public void onActivityResult(ActivityResult result) {
            Intent data = result.getData();
            int resultCode = result.getResultCode();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment__booklist, container, false);

        initData();

        FloatingActionButton fabAdd = rootView.findViewById(R.id.recycle_floatingActionButton);
        fabAdd.setOnClickListener(view ->{
            Intent intent = new Intent(this.getContext(), EDITBOOK.class);
        ...
        private class MyViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
            ...
            public boolean onMenuItemClick(MenuItem menuItem){
                ...
                switch(menuItem.getItemId()){
                    case LIST_ADD:
                        intent = new Intent(Fragment_BOOKLIST.this.getContext() , EDITBOOK.class);
    ...
    private class ActivityResultLauncher<T> {
    }
}